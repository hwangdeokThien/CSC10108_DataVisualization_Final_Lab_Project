...
import { Data, BarChart } from "../../components/Chart/BarTT";
...
const TT: React.FC = () => {
    ...
    const fetchData = async (viewOption: number = 2) => {
        ...
        const filteredOrders = readData.filter(
            (order) =>
                (order["Customer type"] === "Normal" ||
                    order["Customer type"] === "Member") &&
        ...
        filteredBranches.forEach((order) => {
            ...
            revenueByBranch[branch] =
                (revenueByBranch[branch] || 0) + grossIncome;
        });
    ...
    return (
        <div className="w-full m-auto">
            ...
            <div className="w-[80%] m-auto pt-5">
                ...
                <p>
                    Thống kê lượng khách hàng đến cửa hàng mỗi tháng trong năm
                    2019
                </p>
                ...
                <p>
                    Đánh giá: Đồ thị cho ta thấy được khách hàng sẽ đến cửa hàng
                    mua sắm vào tháng 1 (đầu năm) để mua những thế vật phẩm để
                    có thể chuẩn bị cho 1 năm mới. Chính vì thế các cửa hàng
                    phải luôn cung cấp thật nhiều hàng hóa (đặc biệt là phải
                    quan tâm đến các sản phẩm mà nhu cầu của họ) vào đầu năm.
                    Đồng thời, các cửa hàng phải có thêm một số chương trình
                    khuyến mãi nhằm để thu hút khách hàng .
                </p>
                <p>
                    =====================================================================================================================================
                </p>
                ...
                <p>
                    Đánh giá: Đồ thị cho ta thấy chi nhánh C (ở thành phố
                    Naypyitaw của Myanmar) là có thu nhập cao nhất trong cả 3
                    chi nhánh. Qua đây, ta cũng thấy được so hướng người dân
                    đang có khả năng đổ dần thành phố Naypyitaw . Chính vì thế,
                    Chi nhánh C cần phải có thêm kế hoạch để có thể thu hút thêm
                    nhiều khách hàng hơn nữa bằng cách thêm các ưu đãi khi họ
                    đăng kí thành viên. Còn 2 chi nhánh A(Yangon) và B(Mandaly)
                    cần phải đưa ra chiến lược tiếp cận hoặc quảng cáo hiệu quả
                    nhằm có thể thu hút khách hàng để cho họ có thể biết đến cửa
                    hàng của mình.{" "}
                </p>
            </div>
        </div>
